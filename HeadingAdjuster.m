function [adj_heading] = HeadingAdjuster(lat_now,long_now,lat_next,long_next)
    ...
    sld = hypot(x_nm,y_nm); %straight line distance (NM)
    slh_unit = atan2(y_nm,x_nm);
    adj_heading = unit2comp(slh_unit);
end
